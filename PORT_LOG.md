...
| P2 | ad/bsdfs (blender_principled + lobes/tables) + BSDF C++ surface | e1bc2905 (#1822), b1fde2f3, 144aaac8, 95c07233, 638d4920, 8b94cda5, a8f6106a, 81fae57d, f1f01f3a, f6c8054f, 596da59a, 991a1844, fcca650e, 3ac0ff8f, 62936c42, b3c64fb7, faec9175 (rough* floors), 77f35439, 4b19696/8b94cda5 tests | ported | C++ (bsdf.h sampled_roughness_squared, interaction.h min_alpha, microfacet.h filter_glossy_alpha, six BSDF cpps, bindings) 3-way applied; 5 conflicts resolved against master's doc-conversion + instance_index/frame_flipped churn. Python tree verbatim + reload entry. Pre-compile overlay run: 16 passed / 16 failed, every failure `si.min_alpha` absent from the OLD binary -- needs this cluster's compile. principledhelpers.h delta dropped (upstream 366de608 already on master). |
| P3 | Emitters: area si.wi, spot, blender_lamp | 81ea8f2d (4ea28b4a superseded by upstream b9286db1), c3f60515, 4ed80deb, 4ded1df8, 011aa296 (retired into blender_lamp) | pending | plugins/emitters registry + reload entry. |
