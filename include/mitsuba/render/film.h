...
enum class FilmFlags : uint32_t {
    ...
    /**
     * The film provides a customized `Film.prepare_sample()` routine that implements
     * a special treatment of the samples before storing them in the `ImageBlock`.
     */
    Special              = 0x4,
};
...
/**
 * Abstract film base class - used to store samples
 ...
 * is then committed to the film using the `ImageBlock.put()` method.
 */
