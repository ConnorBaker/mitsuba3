...
mi.register_field('float_curve', lambda props: FloatCurve(props))


class RGBCurve(TextureBase):
    '''
...
mi.register_field('rgb_curve', lambda props: RGBCurve(props))
